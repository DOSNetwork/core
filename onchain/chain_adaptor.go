...
type ProxyAdapter interface {
	...
	GroupingThreshold(ctx context.Context) (r uint64, err error)
	...
	BootstrapEndBlk(ctx context.Context) (result uint64, err error)
	BootstrapRound(ctx context.Context) (result uint64, err error)
